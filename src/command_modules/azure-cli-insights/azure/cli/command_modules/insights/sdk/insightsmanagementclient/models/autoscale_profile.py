...
class AutoscaleProfile(Model):
    ...
    :param capacity: the number of instances that can be used during this
     profile.
    :type capacity: :class:`ScaleCapacity <InsightsMgmt.models.ScaleCapacity>`
    :param rules: the collection of rules that provide the triggers and
     ...
     specified.
    :type rules: list of :class:`ScaleRule <InsightsMgmt.models.ScaleRule>`
    :param fixed_date: the specific date-time for the profile. This element
     is not used if the Recurrence element is used.
    :type fixed_date: :class:`TimeWindow <InsightsMgmt.models.TimeWindow>`
    ...
    :type recurrence: :class:`Recurrence <InsightsMgmt.models.Recurrence>`
    """ 
