...
class EventsOperations(object):
    ...
    def list(
        ...
        Operation' and correlationId eq '<CorrelationID>'. No other syntax is
        allowed.
        ...
        :param select: Used to fetch events with only the given properties.
         The filter is a comma separated list of property names to be
        ...
        :rtype: :class:`EventDataPaged <InsightsMgmt.models.EventDataPaged>`
        """
