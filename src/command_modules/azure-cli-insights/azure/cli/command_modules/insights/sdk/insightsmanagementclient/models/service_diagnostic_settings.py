...
class ServiceDiagnosticSettings(Model):
    ...
    :param storage_account_id: The resource ID of the storage account to
     which you would like to send Diagnostic Logs.
    :type storage_account_id: str
    :param service_bus_rule_id: The service bus rule ID of the service bus
     namespace in which you would like to have Event Hubs created for
    ...
    :type metrics: list of :class:`MetricSettings
     <InsightsMgmt.models.MetricSettings>`
    :param logs: the list of logs settings.
    :type logs: list of :class:`LogSettings <InsightsMgmt.models.LogSettings>`
