...
class MetricDefinitionsOperations(object):
    ...
    def list(
        ...
        metric definitions. For example, get just the definition for the CPU
        percentage counter: $filter=name.value eq '\Processor(_Total)\%
        Processor Time'. This $filter is very restricted and allows only
        these 'name eq <value>' clauses separated by or operators. No other
        syntax is allowed.
        ...
        :rtype: :class:`MetricDefinitionPaged
         <InsightsMgmt.models.MetricDefinitionPaged>`
        """
