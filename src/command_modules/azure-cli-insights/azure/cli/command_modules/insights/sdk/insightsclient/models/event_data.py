...
class EventData(Model):
    ...
    :param authorization: the authorization used by the user who has
     ...
     properties of the event. These usually include the 'action', 'role' and
     the 'scope'
    :type authorization: :class:`SenderAuthorization
     <InsightsMgmt.models.SenderAuthorization>`
    ...
    :type channels: str or :class:`EventChannels
     <InsightsMgmt.models.EventChannels>`
    ...
    :type http_request: :class:`HttpRequestInfo
     <InsightsMgmt.models.HttpRequestInfo>`
    :param level: the event level. Possible values include: 'Critical',
     'Error', 'Warning', 'Informational', 'Verbose'
    :type level: str or :class:`EventLevel <InsightsMgmt.models.EventLevel>`
    ...
    :type resource_provider_name: :class:`LocalizableString
     <InsightsMgmt.models.LocalizableString>`
    :param resource_id: the resource uri that uniquely identifies the
    ...
    :param sub_status: the event sub status. Most of the time, when included,
     this captures the HTTP status code of the REST call. Common values are:
     OK (HTTP Status Code: 200), Created (HTTP Status Code: 201), Accepted
    ...
    :param submission_timestamp: the timestamp of when the event became
     available for querying via this API. It is in ISO 8601 format. This
