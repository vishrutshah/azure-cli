...
class MetricsOperations(object):
    ...
    def list(
        ...
        timeGrain. The filter expression uses these properties with
        comparison operators (eg. eq, gt, lt) and multiple expressions can be
        combined with parentheses and 'and/or' operators. Some example filter
        ...
        and timeGrain eq duration'PT1H', - $filter=(name.value eq
        ...
        :param filter: Reduces the set of data collected. The syntax allowed
         depends on the operation. See the operation's description for
         details.
        :type filter: str
        ...
        :rtype: :class:`MetricPaged <InsightsMgmt.models.MetricPaged>`
        """
